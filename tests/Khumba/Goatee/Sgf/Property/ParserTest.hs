...
module Khumba.Goatee.Sgf.Property.ParserTest (tests) where

import Control.Applicative ((<$>))
import Control.Monad (forM_)
import Data.Maybe (catMaybes)
import Khumba.Goatee.Common
import Khumba.Goatee.Sgf.ParserTestUtils
import Khumba.Goatee.Sgf.Property
import Khumba.Goatee.Sgf.Property.Parser
...
tests = testGroup "Khumba.Goatee.Sgf.Property.ParserTest" [
